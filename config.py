...
# High-volatility sessions can make fixed paper-trade anchors too tight. These
# settings only change validation stop/target anchors and quant scoring; they
# do not create or modify real orders.
SIGNAL_HIGH_VOL_ATR_PCT = 0.45
SIGNAL_EXTREME_VOL_ATR_PCT = 0.90
SIGNAL_HIGH_VOL_BB_WIDTH_PCT = 2.20
SIGNAL_EXTREME_VOL_BB_WIDTH_PCT = 4.00
SIGNAL_HIGH_VOL_LEVEL_MULTIPLIER = 1.25
SIGNAL_EXTREME_VOL_LEVEL_MULTIPLIER = 1.50
QUANT_HIGH_VOL_LONG_PENALTY = 5
QUANT_EXTREME_VOL_LONG_PENALTY = 10
QUANT_HIGH_VOL_CAUTION_BONUS = 4
QUANT_EXTREME_VOL_CAUTION_BONUS = 8
QUANT_VOL_OPPORTUNITY_LONG_BONUS = 8
QUANT_VOL_OPPORTUNITY_CAUTION_DISCOUNT = 5
QUANT_VOL_TRAP_LONG_PENALTY = 8
QUANT_VOL_TRAP_CAUTION_BONUS = 6
