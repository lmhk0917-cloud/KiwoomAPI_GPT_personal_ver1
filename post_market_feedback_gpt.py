...
def build_authoritative_metrics(paper_report):
    ...
    return {
        ...
        "cluster_summary": select_metric_fields(paper_report.get("cluster_summary", {}), [
            "cluster_window_minutes",
            "cluster_count",
            "evaluated_cluster_count",
            "evaluated_cluster_60m_count",
            "avg_cluster_return_60m_pct",
            "avg_cluster_net_return_60m_pct",
            "cluster_win_rate_60m_pct",
            "cluster_net_win_rate_60m_pct",
            "cluster_profit_factor_60m",
            "cluster_stop_loss_hit_rate_pct",
        ]),
